      ...
      {loading ? (
        ...
        <div className={styles.page}>
          ...
          <Window title='Sobre mim' icon='user'>
            ...
            <p>
              Meu <strong>principal objetivo</strong> é prover soluções à nível
              do cliente, analisar suas necessidades e dores, me envolver na
              ideia e traçar o melhor <strong>plano de ação</strong> para a
              execução do desenvolvimento para superar positivamente as
              expectativas.
            </p>
          </Window>
          ...
          <Window title='Skills & Tecnologias' icon='code'>
            <p>
              ...
              principalmente se tratando de estruturação de código, organização
              de projetos, design patterns, etc.
            </p>
